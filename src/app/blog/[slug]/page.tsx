...
const articleData = {
  ...
  content: [
    ...
    {
      type: "paragraph" as const,
      text: "Body recomposition, often referred to as \"recomp,\" is the process of changing your body composition by simultaneously gaining muscle and losing fat. Unlike traditional bulk-and-cut cycles, recomposition aims to improve your physique without significant changes in overall body weight.",
    },
    {
      type: "paragraph" as const,
      text: "This approach is particularly appealing because it allows athletes and fitness enthusiasts to maintain their current weight class while dramatically improving their body composition and performance metrics.",
    },
    {
      type: "heading" as const,
    ...
    {
      type: "paragraph" as const,
      text: "Several SARMs have shown particular promise for body recomposition due to their unique mechanisms of action. Here we examine the most effective compounds based on available research and user experiences.",
    },
    {
      type: "heading" as const,
    ...
    {
      type: "paragraph" as const,
      text: "Ostarine is widely considered the best SARM for beginners and recomposition. It provides moderate anabolic effects while helping preserve muscle mass during caloric deficits. Typical dosages range from 10-25mg per day for 8-12 week cycles.",
    },
    {
      type: "heading" as const,
    ...
    {
      type: "paragraph" as const,
      text: "RAD-140 is one of the most potent SARMs available, with strong anabolic properties that make it excellent for building lean muscle. Its high binding affinity to androgen receptors in muscle tissue makes it particularly effective for recomposition when combined with proper training and nutrition.",
    },
    {
      type: "heading" as const,
    ...
    {
      type: "paragraph" as const,
      text: "While technically not a SARM, Cardarine is often stacked with SARMs for recomposition due to its powerful fat-oxidation properties. It works by activating the PPAR-delta pathway, enhancing the body\u2019s ability to burn fat for fuel during exercise.",
    },
    {
      type: "heading" as const,
      text: "Recommended Stack for Recomposition",
    },
    {
      type: "paragraph" as const,
      text: "For those with some experience, a popular recomposition stack combines Ostarine at 20mg/day with Cardarine at 10mg/day for an 8-week cycle. This combination provides muscle-building stimulus while dramatically improving fat oxidation capacity.",
    },
    {
      type: "heading" as const,
      text: "Conclusion",
    ...
    {
      type: "paragraph" as const,
      text: "SARMs offer a promising avenue for body recomposition when used responsibly and in conjunction with proper training and nutrition. Always ensure you source products from verified, lab-tested suppliers and consider a proper PCT protocol after your cycle.",
    },
  ],
};
          ...
          <div className="flex gap-10">
              ...
              <article className="prose-custom">
                {articleData.content.map((block, i) => {
                  if (block.type === "heading") {
                    return (
                      <h2 key={i} className="text-[22px] font-extrabold text-[#181818] leading-[30px] mt-8 mb-3">
                        {block.text}
                      </h2>
                    );
                  }
            ...
            <div className="w-[340px] shrink-0">
              <div className="sticky top-4 flex flex-col gap-8">
                    ...
                    {articleData.content
                      ...
                      .map((heading, i) => (
                        <a
                          key={i}
                          href={`#section-${i}`}
                          className="text-sm text-[#7E7E7E] hover:text-[#FF6701] transition-colors leading-5"
                        >
                          {heading.text}
                        </a>
                      ))}
                ...
                {/* Newsletter */}
                <div className="bg-[#F7F7F7] rounded-[12px] p-5">
                  <h3 className="text-[16px] font-extrabold text-[#181818] mb-2">Stay Updated</h3>
                  <p className="text-sm text-[#7E7E7E] mb-4">Get the latest articles delivered to your inbox</p>
                  <input
                    type="email"

    ...
    <div className="bg-white border border-[#E7E7E7] rounded-[16px] overflow-hidden flex flex-col w-[252px] shrink-0 hover:shadow-lg transition-shadow">
      ...
      <Link href="/product" className="relative h-[252px] bg-white flex items-center justify-center p-6 block">
        ...
        <div className="absolute top-3 left-3 flex flex-col gap-1.5">
          ...
          {badges.includes("new") && (
            <span className="bg-[#00A9DE] text-white text-[11px] font-semibold px-3 py-1 rounded-[6px]">New</span>
          )}
        </div>
        {image ? (
          <Image src={image} alt={name} width={180} height={180} className="object-contain" unoptimized />
        ) : (
      ...
      <div className="p-4 flex flex-col gap-1.5 flex-1">
        ...
        <div className="flex items-center gap-2 mt-3">
          ...
          <button
            ...
            className="flex-1 bg-[#FF6701] hover:bg-[#E65D00] transition-colors rounded-[10px] h-[40px] flex items-center justify-center"
          >
